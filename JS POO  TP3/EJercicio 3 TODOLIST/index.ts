import { GestorTareas } from './gestorTarea/gestorTareas';
import { Dificultad, Estado } from './gestorTarea/tarea';
        ...
        switch (opcion) {
            ...
            case "3":
                ...
                if (estadoInput === 'pendiente' || estadoInput === 'en curso' || estadoInput === 'terminada' || estadoInput === 'cancelada') {
                    gestor.buscarPorEstado(estadoInput as Estado);
                } else {
            ...
            case "4":
                ...
                if (dificultadInput === 'facil' || dificultadInput === 'intermedia' || dificultadInput === 'dificil') {
                    gestor.buscarPorDificultad(dificultadInput as Dificultad);
                } else {
